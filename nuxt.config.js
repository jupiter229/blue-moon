  ...
  head: {
    ...
    meta: [
      ...
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        hid: "description",
        name: "description",
        content: meta.data.siteDescription,
      },
      ...
      { name: "twitter:card", content: "summary_large_image" },
      {
        hid: "twitter:site",
        name: "twitter:site",
        content: meta.data.socialUrl,
      },
      { name: "twitter:creator", content: meta.data.socialHandle },
      {
        hid: "twitter:image",
        name: "twitter:image",
        content: meta.data.socialCard,
      },
    ...
    link: [
      {
        rel: "icon",
        type: "image/x-icon",
        href: "/images/bluemoon-favicon.png",
      },
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Jura:wght@500;700&display=swap",
      },
      {
        rel: "stylesheet",
